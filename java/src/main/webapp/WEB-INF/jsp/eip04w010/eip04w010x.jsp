...
<form:form id="eip04w010Form" modelAttribute="${caseKey}">
    <tags:form-row>
        <div class="col-md-6">
...
$(function(){
    $('#btnSave').click(function(){
        $('#eip04w010Form').attr('action', '<c:url value="/Eip04w010_saveOrModify.action" />').submit();
    })
    $('#btnReply').click(function(){
        $('#eip04w010Form').attr('action', '<c:url value="/Eip04w010_enter.action" />').submit();
    })
})
</script>
</jsp:attribute>
