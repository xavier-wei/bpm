...
<!doctype html>
<spring:eval var="caseKey" expression="T(tw.gov.pcc.eip.common.controllers.Eip05w030Controller).CASE_KEY" />
...
<form:form id="eip05w030Form" modelAttribute="${caseKey}">
    <%@ include file="/WEB-INF/jsp/eip05w020/eip05w000x.jsp" %>
...
$(function(){
    ...
    $('#btnInsert').click(function(e){
        ...
        $('#eip05w030Form').attr('action', '<c:url value="/Eip05w030_send.action" />').submit();
    })
    ...
    $('#btnReply').click(function(e){
        e.preventDefault();
        $('#eip05w030Form').attr('action', '<c:url value="/Eip05w030_enter.action" />').submit();
    })
