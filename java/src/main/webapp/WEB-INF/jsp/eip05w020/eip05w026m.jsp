...
$(function(){
    $('#btnExport').click(function(e){
        ...
        $('#eip05w020Form').attr('action', '<c:url value="/Eip05w020_printQueryWriteContent.action" />').submit();
    })
    $('#btnReview').click(function(e){
        ...
        $('#eip05w020Form').attr('action', '<c:url value="/Eip05w020_writeContent.action" />').submit();
    })
