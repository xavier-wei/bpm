...
<spring:eval var="partCaseKey" expression="T(tw.gov.pcc.eip.common.controllers.Eip05w020Controller).PART_CASE_KEY" />
...
<form:form id="eip05w020Form" modelAttribute="${partCaseKey}">
    <tags:form-row>
        <div class="col-md-6">
...
$(function(){
    $('#btnSave').click(function(){
        $('#eip05w020Form').attr('action', '<c:url value="/Eip05w020_partConfirm.action" />').submit();
    })
