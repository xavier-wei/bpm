...
$(function(){
	...
	$('#btnInsert').click(function(e){
        e.preventDefault();
        $('#mode').val('A');
		$('#eip05w020Form').attr('action', '<c:url value="/Eip05w020_selectQuestionInsertUpdate.action" />').submit();
	})
    $('#btnDelete').click(function(e){
        ...
        showConfirm('確定刪除嗎？',()=>{
            $('#eip05w020Form').attr('action', '<c:url value="/Eip05w020_questionDelete.action" />').submit();
        });
    })
    ...
    $('#tb1 button.option').click(function(e){
        ...
        $('#eip05w020Form').attr('action', '<c:url value="/Eip05w020_optionList.action" />').submit();
    });
