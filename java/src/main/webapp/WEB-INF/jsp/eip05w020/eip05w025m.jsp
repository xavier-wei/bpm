...
<spring:eval var="optionCaseKey" expression="T(tw.gov.pcc.eip.common.controllers.Eip05w020Controller).OPTION_CASE_KEY" />
...
<form:form id="eip05w020Form" modelAttribute="${optionCaseKey}">
    <tags:form-row>
        <div class="col-md-6">
...
$(function(){
    ...
    $('#btnInsert').click(function(e){
        e.preventDefault();
        $('#mode').val('A');
        $('#eip05w020Form').attr('action', '<c:url value="/Eip05w020_optionInsertUpdate.action" />').submit();
    })
    ...
    $('#btnDelete').click(function(e){
        ...
        showConfirm('確定刪除嗎？',()=>{
            $('#eip05w020Form').attr('action', '<c:url value="/Eip05w020_optionDelete.action" />').submit();
        });
    })
