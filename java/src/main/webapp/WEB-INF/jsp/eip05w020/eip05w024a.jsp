...
<spring:eval var="questionCaseKey" expression="T(tw.gov.pcc.eip.common.controllers.Eip05w020Controller).QUESTION_CASE_KEY" />
...
<form:form id="eip05w020Form" modelAttribute="${questionCaseKey}">
    <tags:form-row>
        <div class="col-md-6">
...
$(function(){
    $('#btnSave').click(function(){
        $('#eip05w020Form').attr('action', '<c:url value="/Eip05w020_questionConfirm.action" />').submit();
    })
