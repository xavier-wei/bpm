...
<!doctype html>
<spring:eval var="caseKey" expression="T(tw.gov.pcc.eip.common.controllers.Eip04w030Controller).CASE_KEY" />
...
<tags:fieldset legend="線上報名">
    ...
    <form:form id="eip04w030Form" name="eip04w030Form" modelAttribute="${caseKey}" method="POST">
        <tags:form-row>
...
$(function(){
    ...
    $('.btnContent,.btnHisContent').click(function(e) {
        ...
        $('#eip04w030Form').attr('action', '<c:url value="/Eip04w030_content.action" />').submit();
    });

    $('.btnReg').click(function(e) {
        e.preventDefault();
        $('#orformno').val($(this).data('formno'));
        $('#eip04w030Form').attr('action', '<c:url value="/Eip04w030_register.action" />').submit();
    });

    $('.btnCancel').click(function(e) {
        e.preventDefault();
        $('#orformno').val($(this).data('formno'));
        $('#eip04w030Form').attr('action', '<c:url value="/Eip04w030_cancel.action" />').submit();
    });
