...
$(function(){
    $('#btnReply').click(function(e){
        e.preventDefault();
        $('#eip04w030Form').attr('action', '<c:url value="/Eip04w030_enter.action" />').submit();
    })

    $('#eip04w030Form a').click(function(e){
        e.preventDefault();
        $('#filename').val($(this).text());
        $('#eip04w030Form').attr('action', '<c:url value="/Eip04w030_download.action" />').submit();
    })
})
</script>
</jsp:attribute>
