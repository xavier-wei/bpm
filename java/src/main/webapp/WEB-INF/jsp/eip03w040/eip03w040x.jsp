...
<%-- 重要列管事項_件數統計 --%>
<!doctype html>
<spring:eval var="caseKey" expression="T(tw.gov.pcc.eip.common.controllers.Eip03w040Controller).CASE_KEY" />
...
<script>
    $(function(){
        ...
        $('#btnBack').click(function(e) {
            e.preventDefault();
            $('#eip03w040Form').attr('action', 'Eip03w040_enter.action').submit();
        });

        $('#btnPrint').click(function(e) {
            e.preventDefault();
            $('#eip03w040Form').attr('action', 'Eip03w040_print.action').submit();
        });
    })
</script>
</jsp:attribute>
