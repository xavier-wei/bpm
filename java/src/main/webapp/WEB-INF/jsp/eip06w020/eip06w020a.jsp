...
<%-- 會議室預約作業 --%>
<!doctype html>
<spring:eval var="caseKey" expression="T(tw.gov.pcc.eip.common.controllers.Eip06w020Controller).CASE_KEY" />
...
<script>
    $(function(){
        ...
        $('#btnSave').click(function(e) {
            ...
            $('#eip06w020Form').attr('action', 'Eip06w020_save.action').submit();
        });
        ...
        $('select[name="meetingEnd"]').change(function (){
            ...
            $.ajax({
                url: '<c:url value="Eip06w020_isMeetingEndValid.action"/>',
                type: 'POST',
    ...
    function findValidRoom() {
        ...
        $.ajax({
            url: '<c:url value="Eip06w020_findValidRoom.action"/>',
            type: 'POST',
            contentType : 'application/json',
            data: JSON.stringify(data),
            success: function (data){
