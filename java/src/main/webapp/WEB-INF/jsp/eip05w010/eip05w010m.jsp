...
<jsp:attribute name="contents">
    ...
    <form:form id="eip05w010Form" name="eip05w010Form" modelAttribute="${caseKey}" method="POST">
        <tags:form-row>
...
$(function(){
	...
	$('#btnInsert').click(function(e){
        e.preventDefault();
        $('#mode').val('A');
		$('#eip05w010Form').attr('action', '<c:url value="/Eip05w010_selectAction.action" />').submit();
	})
    $('#btnDelete').click(function(e){
        ...
        showConfirm('確定刪除嗎？',()=>{
            $('#eip05w010Form').attr('action', '<c:url value="/Eip05w010_delete.action" />').submit();
        });
    })
