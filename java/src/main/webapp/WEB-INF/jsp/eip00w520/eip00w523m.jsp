...
$(function(){
	...
	$('#btnInsert').click(function(e){
        e.preventDefault();
        $('#mode').val('A');
		$('#eip00w520Form').attr('action', '<c:url value="/Eip00w520_selectPartInsertUpdate.action" />').submit();
	})
    $('#btnDelete').click(function(e){
        ...
        showConfirm('確定刪除嗎？',()=>{
            $('#eip00w520Form').attr('action', '<c:url value="/Eip00w520_partDelete.action" />').submit();
        });
    })
