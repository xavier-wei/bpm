...
<spring:eval var="themeKey" expression="T(tw.gov.pcc.eip.common.controllers.Eip00w520Controller).THEME_CASE_KEY" />
...
<form:form id="eip00w520Form" modelAttribute="${themeKey}" >
    <tags:form-row>
        <div class="col-md-12">
...
$(function(){
    $('#btnSave').click(function(e){
        e.preventDefault();
        $('#eip00w520Form').attr('action', '<c:url value="/Eip00w520_confirm.action" />').submit();
    })
    ...
    $("input[name='osfmdtChksys']").click(function() {
        changeosFmdtChksys();
    });
    ...
    $("input[name='osendtChksys']").click(function() {
        changeosEndtChksys();
    });
