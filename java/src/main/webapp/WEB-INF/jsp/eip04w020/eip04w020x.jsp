...
<spring:eval var="modifyKey" expression="T(tw.gov.pcc.eip.common.controllers.Eip04w020Controller).MODIFY_CASE_KEY" />
...
<form:form id="eip04w020Form" modelAttribute="${modifyKey}" enctype="multipart/form-data" method="post">
    <tags:form-row>
        <div class="col-md-12">
    ...
    <tags:form-row>
        <div class="col-md-12">
            ...
            <form:input path="topicname" cssClass="form-control d-inline-block trimS" placeholder="最長50字" size="50" maxlength="50"/>
        </div>
    </tags:form-row>
    <tags:form-row>
        <div class="col-md-12">
            <form:label cssClass="col-form-label star" path="regisfmdt">報名開始時間：</form:label>
            <form:input path="regisfmdt" cssClass="form-control d-inline-block dateTW cdate" placeholder="日期" size="10" maxlength="9"/>
    ...
    <tags:form-row>
        <div class="col-md-12">
            ...
            <form:input path="regisendt" cssClass="form-control d-inline-block dateTW cdate" placeholder="日期" size="10" maxlength="9"/>
    ...
    <tags:form-row>
        <div class="col-md-12">
            ...
            <form:input path="organizer" cssClass="form-control d-inline-block trimS" placeholder="最長50字" size="50" maxlength="50"/>
        </div>
    </tags:form-row>
    <tags:form-row>
        <div class="col-md-12">
            <form:label cssClass="col-form-label star" path="contacter">聯絡人：</form:label>
            <form:input path="contacter" cssClass="form-control d-inline-block trimS" size="20" maxlength="6"/>
        </div>
    </tags:form-row>
    <tags:form-row>
        <div class="col-md-12">
            <form:label cssClass="col-form-label star" path="contactnum">聯絡電話：</form:label>
            <form:input path="contactnum" cssClass="form-control d-inline-block tel trimS" size="20" maxlength="20"/>
        </div>
    </tags:form-row>
    <tags:form-row>
        <div class="col-md-12">
            <form:label cssClass="col-form-label" path="fax">傳真：</form:label>
            <form:input path="fax" cssClass="form-control d-inline-block tel trimS" size="20" maxlength="20"/>
        </div>
    </tags:form-row>
    <tags:form-row>
        <div class="col-md-12">
    ...
    <tags:form-row>
        <div class="col-md-12">
            ...
            <form:input path="addres" cssClass="form-control d-inline-block trimS" placeholder="最長50字" size="50" maxlength="50"/>
        </div>
    </tags:form-row>
    <tags:form-row>
        <div class="col-md-12">
    ...
    <tags:form-row>
        <div class="col-md-12">
            ...
            <form:input path="profmdt" cssClass="form-control d-inline-block dateTW cdate" placeholder="日期" size="10" maxlength="9"/>
    ...
    <tags:form-row>
        <div class="col-md-12">
            ...
            <form:input path="proendt" cssClass="form-control d-inline-block dateTW cdate" placeholder="日期" size="10" maxlength="7"/>
    ...
    <tags:form-row>
        <div class="col-md-12">
            ...
            <form:input path="account" cssClass="form-control d-inline-block tel trimS" size="30" maxlength="30"/>
        </div>
    </tags:form-row>
    <tags:form-row>
        <div class="col-md-12">
...
$(function(){
    ...
    $('#btnSave').click(function(e){
        ...
        $('#eip04w020Form').attr('action', '<c:url value="/Eip04w020_confirm.action" />').submit();
    })
