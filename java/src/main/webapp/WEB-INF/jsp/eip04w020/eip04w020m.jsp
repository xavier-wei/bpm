    ...
    <form:form id="eip04w020Form" name="eip04w020Form" modelAttribute="${caseKey}" method="POST">
        <tags:form-row>
            <div class="col-lg-12 col-xl-11">
                ...
                <form:input path="qKeyword" cssClass="form-control d-inline-block trimS" size="13" maxlength="50"/>
                ...
                <form:input path="qStartYear" cssClass="form-control d-inline-block padL mr-1 num_only" placeholder="年" size="2" maxlength="3"/>/
                <form:input path="qStartMonth" cssClass="form-control d-inline-block padL num_only" placeholder="月" size="2" maxlength="2"/>
                <span class="">~</span>
                <form:input path="qEndYear" cssClass="form-control d-inline-block padL mr-1 num_only" placeholder="年" size="2" maxlength="3"/>/
                <form:input path="qEndMonth" cssClass="form-control d-inline-block padL num_only" placeholder="月" size="2" maxlength="2"/>
            </div>
...
$(function(){
	...
	$('#btnSearch').click(function(e){
        e.preventDefault();
		$('#eip04w020Form').attr('action', '<c:url value="/Eip04w020_advQuery.action" />').submit();
	})
    $('#btnInsert').click(function(e){
        e.preventDefault();
        $('#mode').val('A');
        $('#eip04w020Form').attr('action', '<c:url value="/Eip04w020_selectInsertUpdate.action" />').submit();
    })
    ...
    $('#btnPut').click(function(e){
        ...
        $('#eip04w020Form').attr('action', '<c:url value="/Eip04w020_put.action" />').submit();
    })
    ...
    $('#btnDelete').click(function(e){
        ...
        showConfirm('確定刪除嗎？',()=>{
            $('#eip04w020Form').attr('action', '<c:url value="/Eip04w020_delete.action" />').submit();
        });
    })
    ...
    $('#btnDisabled').click(function(e){
        ...
        showConfirm('確定停辦嗎？',()=>{
            $('#eip04w020Form').attr('action', '<c:url value="/Eip04w020_disabled.action" />').submit();
        });
    })
    ...
    $('#tb1 button').click(function(e){
        ...
        if ($(this).prev().val() === 'U') {
            ...
            $('#eip04w020Form').attr('action', '<c:url value="/Eip04w020_manualReg.action" />').submit();
        } else if ($(this).prev().val() === 'C') {
            $('#eip04w020Form').attr('action', '<c:url value="/Eip04w020_copy.action" />').submit();
        } else if ($(this).prev().val() === 'H') {
            $('#eip04w020Form').attr('action', '<c:url value="/Eip04w020_history.action" />').submit();
        } else if ($(this).prev().val() === 'V') {
            $('#eip04w020Form').attr('action', '<c:url value="/Eip04w020_verify.action" />').submit();
        } else if ($(this).prev().val() === 'A') {
            $('#eip04w020Form').attr('action', '<c:url value="/Eip04w020_certified.action" />').submit();
        } else if ($(this).prev().val() === 'P') {
            $('#eip04w020Form').attr('action', '<c:url value="/Eip04w020_printSigninList.action" />').submit();
        } else if ($(this).prev().val() === 'E1') {
            $('#eip04w020Form').attr('action', '<c:url value="/Eip04w020_printCSV.action" />').submit();
        } else if ($(this).prev().val() === 'E2') {
            $('#eip04w020Form').attr('action', '<c:url value="/Eip04w020_printExcel.action" />').submit();
        }
    });
