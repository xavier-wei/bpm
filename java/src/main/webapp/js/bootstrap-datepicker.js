...
(function(factory){
    ...
    var Datepicker = function(element, options){
        ...
        if (this.isInline){
            ...
            this.picker.css("padding","0.5rem 0.5rem");
        }
    ...
    Datepicker.prototype = {
        ...
        _fill_yearsView: function(selector, cssClass, factor, year, startYear, endYear, beforeFn){
            ...
            for (var currVal = startVal - step; currVal <= endVal + step; currVal += step) {
                ...
                html += '<span class="' + classes.join(' ') + '"' + (tooltip ? ' title="' + tooltip + '"' : '') + '>' + (currVal - (this.o.language == "zh-TW" ? 1911 : 0)) + '</span>'; //EDIT
            }

            //view.find('.datepicker-switch').text(startVal + '-' + endVal);
            view.find('.datepicker-switch').text((startVal - (this.o.language == "zh-TW" ? 1911 : 0)) + '-' + (endVal  - (this.o.language == "zh-TW" ? 1911 : 0))); //EDIT
        ...
        fill: function(){
            ...
            var months = this.picker.find('.datepicker-months')
                ...
                .text(year - (this.o.language == "zh-TW" ? 1911 : 0)) //EDIT
                .end()
