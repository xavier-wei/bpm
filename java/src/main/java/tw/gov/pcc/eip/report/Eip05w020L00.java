 ...
 * @author Weith
 */
public class Eip05w020L00 extends XlsReport {
	 ...
	 * 增加標題與表頭
	 */
    public void addHeader(Eip05w020Case caseData) {
     ...
     * @param
     */
    public void addContent(Eip05w020Case caseData) {
        List<Eip05w020Case.MixCase>reviews = caseData.getReviews();
        Map<String, Eip05w020Case.Statistics>multipleDataMap = caseData.getMultipleDataMap();
        Map<String,List<String>> textUiMap = caseData.getTextUiMap();
        Map<String, Eip05w020Case.Statistics>textDataMap = caseData.getTextDataMap();
        int rowindex = 6;
        for (int i = 0; i < reviews.size(); i++) {
            Eip05w020Case.MixCase c = reviews.get(i);
...
////        eip05w020L00.addHeader();
//        eip05w020L00.addContent();
//        byte[] byteArray = eip05w020L00.getOutputStream().toByteArray();
