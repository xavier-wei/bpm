 ...
 */
@Service
public class Eip00w430Service extends OnlineRegService {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(Eip00w430Service.class);
    @Autowired
    UserBean userData;
    @Autowired
     ...
     * @param caseData
     */
    public void getContent(Eip00w430Case caseData) throws IOException {
        ...
        Eip00w430Case.ContentCase contentCase = new Eip00w430Case.ContentCase();
     ...
     * @param caseData
     */
    public void register(Eip00w430Case caseData) {
     ...
     * @param caseData
     */
    public void registerCancel(Eip00w430Case caseData) {
     ...
     * @param result
     */
    public void validRegister(Eip00w430Case caseData, BindingResult result) {
        Orformdata orformdata = orformdataDao.findByPk(caseData.getOrformno());
