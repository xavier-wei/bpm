...
@Data
@NoArgsConstructor
public class Eip03w050Case implements Serializable {
...
//    初始頁
    ...
    private List<Eip03w050Case> eip03w040CaseList = new ArrayList<>();
...
//    查詢表頁
    ...
    private List<Eip03w050Case> eip03w040CaseDetailList = new ArrayList<>();
