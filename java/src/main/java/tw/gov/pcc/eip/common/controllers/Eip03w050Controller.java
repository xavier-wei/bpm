...
@Controller
public class Eip03w050Controller extends BaseController {
    private static final Logger log = LoggerFactory.getLogger(Eip03w050Controller.class);

    public static final String CASE_KEY = "_eip03w040CController_caseData";
    private static final String QUERY_PAGE =  "/eip03w050/eip03w050q";
    private static final String DETAIL_PAGE =  "/eip03w050/eip03w050x";
    ...
    public Eip03w040Case getEip03w050Case(){
     ...
     *
     */
    @RequestMapping("/Eip03w050_enter.action")
    public String enter() {
    ...
    @RequestMapping("/Eip03w050_queryIssue.action")
     ...
     * @return
     */
    @RequestMapping("/Eip03w050_print.action")
