 ...
 * @author Weith
 */
public class Eip04w020L02 extends XlsReport {
	...
	public Eip04w020L02(Map<String,String> deptMap, Map<String,String> titleMap, Map<String,String> companyMap) {
		super(false);
		sheet = createSheet("");
...
//        bodyRightValueStyle.setDataFormat(format.getFormat("#,##0"));
    ...
    public void addContent(List<Orresult> list) {
        for (Orresult orresult : list) {
            ...
            metadata.add(Pair.of(deptMap.get(orresult.getDept()), bodyLeftStyle));
            ...
            metadata.add(Pair.of(titleMap.get(orresult.getJogtitle()), bodyLeftStyle));
            metadata.add(Pair.of(companyMap.get(orresult.getCompany()), bodyLeftStyle));
            metadata.add(Pair.of(deptMap.get(orresult.getDept()), bodyLeftStyle));
