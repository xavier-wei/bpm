...
@Controller
@Slf4j
public class Bpm01w060Controller {

    public static final String CASE_KEY = "_bpm01w060Controller_caseData";
    private static final String MAIN_PAGE = "/bpm/Bpm01w060";//主頁
    private final String MAPPING_PATH = "/Bpm01w060_enter.action";
    private final UserBean userData;
    private final AESEncryptionService aesEncryptionService;

    public Bpm01w060Controller(UserBean userData, AESEncryptionService aesEncryptionService) {
    ...
    public ModelAndView setSupervisor(HttpServletRequest request) {
        ...
        if (!isBpmLogin) {
            ...
            StringBuilder path = new StringBuilder(referer)
                    ...
                    .append("?referer=")
                    .append(referer)
                    .append("&path=/Bpm01w060_enter.action&token=")
                    .append(token);
        ...
        log.info("BPM表單管理:: 導向{}頁面","Bpm01w060 BPM表單特例管理");
        return new ModelAndView(MAIN_PAGE).addAllObjects(Map.of("bpmPath", referer + "/bpm/setSupervisor"));
    }
}
