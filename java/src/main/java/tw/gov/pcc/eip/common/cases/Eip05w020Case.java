...
public class Eip05w020Case implements Serializable {
    ...
    private List<Eip05w020PartCase> partList = new ArrayList<>();

    private List<Eip05w020QuestionCase> questionList = new ArrayList<>();

    private List<Eip05w020OptionCase> optionList = new ArrayList<>();

    private List<Eip05w020QuestionCase> previews = new ArrayList<>();

    private List<Eip05w020QuestionCase> contents = new ArrayList<>();
    ...
    private Eip05w020ThemeCase themeCase;
