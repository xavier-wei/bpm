    ...
    <tags:fieldset>
		...
		<tags:form-row>
			...
			<label class="col-form-label text-left star">身分證號(駕照證號):</label>
		       	<div>
					<form:input id="id"  name="id"  path="eip07w010QueryDataList[0].id" cssClass="form-control" size="7" maxlength="6"/>
				</div>
		...
		<tags:form-row>
			...
			<label class="col-form-label text-left star">手機號碼:</label>
		       	<div>
					<form:input id="cellphone"  name="cellphone"  path="eip07w010QueryDataList[0].cellphone" cssClass="form-control" size="7" maxlength="6"/>
				</div>
			<label class="col-form-label text-left">連絡電話:</label>
		       	<div>
					<form:input id="phone"  name="phone"  path="eip07w010QueryDataList[0].phone" cssClass="form-control" size="7" maxlength="6"/>
				</div>
		</tags:form-row>
		...
		<tags:form-row>
			<label class="col-form-label text-left star">出生日期:</label>
		       	<div>
					<form:input id="brdte"  name="brdte"  path="eip07w010QueryDataList[0].brdte" cssClass="form-control" size="7" maxlength="6"/>
				</div>
		</tags:form-row>
		...
		<tags:form-row>
			...
			<label class="col-form-label text-left ">到職日期:</label>
		       	<div>
					<form:input id="startworkDate"  name="startworkDate"  path="eip07w010QueryDataList[0].startworkDate" cssClass="form-control" size="7" maxlength="6"/>
				</div>
				<label class="col-form-label text-left">離職日期:</label>
		       	<div>
					<form:input id="endworkDate"  name="endworkDate"  path="eip07w010QueryDataList[0].endworkDate" cssClass="form-control" size="7" maxlength="6"/>
				</div>
		</tags:form-row>
		...
		<tags:form-row>
			<label class="col-form-label text-left">駕照到期日:</label>
		       	<div>
					<form:input id="licenceExpireDate"  name="licenceExpireDate"  path="eip07w010QueryDataList[0].licenceExpireDate" cssClass="form-control" size="7" maxlength="6"/>
				</div>
