...
public class PageXofYHelper extends PdfPageEventHelper {
     ...
     * @param y 位置 <code>Y</code> 軸
     */
    public PageXofYHelper(int fontSize, String prefix, String middle, String suffix, int x, int y) throws ReportException {
        super();
    ...
    public void onEndPage(PdfWriter writer, Document document) {
        String text = StringUtils.defaultString(prefix) + String.valueOf(writer.getPageNumber()) + StringUtils.defaultString(middle);
