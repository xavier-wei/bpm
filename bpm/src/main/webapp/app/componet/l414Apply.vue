              ...
              <b-tab title="表單" :active="activeTab(0)" @click="changeTabIndex(0)">
                ...
                <div class="card" style="background-color: #d3ede8">
                        ...
                        >
                          ...
                          <b-form-radio-group v-model="$v.selecteEdateType.$model">
                            <b-form-radio value="1">
                              ...
                              <i-dual-date-picker :disabled="$v.selecteEdateType.$model !== '1'"
                                                  :dual1.sync="$v.sDate.$model" :dual2.sync="$v.eDate.$model"/>
                            </b-form-radio>
                            <b-form-radio value="2">
                              <!--職務異動止說明 : othereEdate-->
                  ...
                  <div class="card m-3" style="background-color: white" >
                    ...
                    <b-form-row>
                      <i-form-group-check class="col-sm-12" label-cols="2" content-cols="8" :label="'實際完成日期 : '"
